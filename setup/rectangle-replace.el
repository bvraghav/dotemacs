;;; rectangle-replace.el --- a simple package                     -*- lexical-binding: t; -*-

;; Copyright (C) 2016  B.V. Raghav

;; Author: B.V. Raghav <r@bvraghav.com>
;; Keywords: rectangle, search, replace
;; Version: 0.0.1
...
;; Rectangle Replace
;; ----------------------------------------------------------------------
;; The rectangle replace functions (from stack overflow)
;; http://stackoverflow.com/questions/11130546/search-and-replace-inside-a-rectangle-in-emacs
...
(provide 'rectangle-replace)
;;; rectangle-replace.el ends here
